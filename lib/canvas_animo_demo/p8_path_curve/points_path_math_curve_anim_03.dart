...
class _Paper03State extends State<Paper03> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: CustomPaint(
        // 使用CustomPaint
        painter: Paper03Painter(_controller),
      ),
    );
  }
...
class Paper03Painter extends CustomPainter {
  ...
  Paper03Painter(this.repaint) : super(repaint: repaint) {
    _paint = Paint()
      ..color = Colors.red
      ..strokeWidth = 2
  ...
  void paint(Canvas canvas, Size size) {
    ...
    pms.forEach((element) {
      ...
      canvas.drawCircle(tangent.position, 4, _pointPaint..color = Colors.green);
    });
  ...
  @override
  bool shouldRepaint(covariant Paper03Painter oldDelegate) =>
