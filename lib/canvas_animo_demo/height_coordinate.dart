...
class Paper0 extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Container(
      ...
      child: CustomPaint(
        // 使用CustomPaint
        painter: Paper0Painter(),
      ),
    );
  }
}

class Paper0Painter extends CustomPainter {
  final BetterCoordinate coordinate = BetterCoordinate(step: 25);
  ...
  @override
  bool shouldRepaint(Paper0Painter oldDelegate) => false;
}