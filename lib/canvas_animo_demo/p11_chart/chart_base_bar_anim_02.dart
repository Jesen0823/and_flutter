...
class Chart02 extends StatefulWidget {
  const Chart02({Key? key}) : super(key: key);

  @override
  State<Chart02> createState() => _Chart02State();
}

class _Chart02State extends State<Chart02> with SingleTickerProviderStateMixin{
    ...
    return Stack(
      ...
      children: [
        Container(
          ...
          child: CustomPaint(
            painter: Chart02Painter(repaint: _controller),
          ),
        ),
        Padding(
...
class Chart02Painter extends CustomPainter {
  ...
  Chart02Painter({required this.repaint}):super(repaint: repaint) {
