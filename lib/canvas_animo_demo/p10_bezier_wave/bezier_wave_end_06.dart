...
//// 贝赛尔曲线封装的loading波浪控件
class BezierWaveLoading extends StatefulWidget {
  // 波高
  ...
  @override
  _BezierWaveLoadingState createState() => _BezierWaveLoadingState();
}

class _BezierWaveLoadingState extends State<BezierWaveLoading>
...
class PaperPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.translate(-4 * waveWidth + 2 * waveWidth * repaint.value,
        wrapHeight + waveHeight);
    drawWave(canvas);
    canvas.drawPath(
        _mainPath,
        _mainPaint
