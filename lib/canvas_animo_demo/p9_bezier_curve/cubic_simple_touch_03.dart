  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        color: Colors.white,
        child: CustomPaint(
          painter: Paper03Painter(repaint: touchInfo),
        ),
      ),
    );
  }
...
class Paper03Painter extends CustomPainter {
  ...
  Paper03Painter({required this.repaint}) : super(repaint: repaint) {
    _paint = Paint()
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (pos.length < 4) {
      ...
      _path.cubicTo(pos[1].dx, pos[1].dy, pos[2].dx, pos[2].dy, pos[3].dx, pos[3].dy);
